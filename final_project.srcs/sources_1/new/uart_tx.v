module uart_tx (
    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            tx_shift_reg <= {1'b1, 
            (tx_data[23:16] != 8'b0) ? ((tx_data[15:8] != 8'b0) ? tx_data[23:16] : tx_data[15:8]) : tx_data[7:0]
            , 1'b0};
            tx_byte_count <= (tx_data[23:16] != 8'b0) ? ((tx_data[15:8] != 8'b0) ? 3 : 2) : 1;
            bit_counter <= 10;
            tx_busy <= 1;
            ...
            if (bit_counter == 0) begin
                if (tx_byte_count > 1) begin
                    ...
                    tx_shift_reg <= {1'b1, (tx_byte_count == 3) ? tx_data[15:8] : tx_data[7:0], 1'b0};
                    bit_counter <= 10;
                end else begin
