...
synth_design -top uart_system -part xc7a35tcpg236-1
...
generate_parallel_reports -reports { "report_utilization -file uart_system_utilization_synth.rpt -pb uart_system_utilization_synth.pb"  } 
