...
HD_PWD='C:/Users/User/Vivado/HWLAB_final_project/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Display_system.tcl -notrace
