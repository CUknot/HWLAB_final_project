...
HD_PWD='C:/Users/User/Vivado/HWLAB_final_project/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Display_system.tcl
