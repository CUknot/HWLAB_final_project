...
#
# Script generated by Vivado on Sat Dec 07 18:05:17 +0700 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/User/Vivado/HWLAB_final_project/project_3.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
